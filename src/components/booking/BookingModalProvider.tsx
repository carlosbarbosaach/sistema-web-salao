...
const open = (o?: OpenBookingOptions) => { if (o?.date) setDate(o.date); setPresetServiceId(o?.presetServiceId); setOpen(true); };
const close = () => setOpen(false);
return (
<Ctx.Provider value={{ isOpen, open, close }}>
{children}
<BookingModal isOpen={isOpen} onClose={close} date={date} presetServiceId={presetServiceId} />
</Ctx.Provider>
);
}